class KochSnowflake {
  ...
  void changeColor(int note, int alpha) {
    ...
    int[] colorsR = {204, 0, 26, 174, 162, 161, 210, 255, 246, 221, 236, 250};
    int[] colorsG = {193, 101, 134, 209, 208, 206, 239, 239, 139, 50, 0, 198};
    int[] colorsB = {219, 169, 168, 233, 207, 94, 219, 108, 105, 50, 140, 204}; 
